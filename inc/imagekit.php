 ...
 */
function tcci_get_customizer_image_info( $name ) {
	...
	$id = tcci_get_image_id( $image_url );
...
} // tcci_get_customizer_image_info()
 ...
 */
function tcci_get_featured_images( $postID ) {
 ...
 */
function tcci_get_image_id( $image_url ) {
 ...
 */
function tcci_get_svg( $svg ) {

	if ( empty( $svg ) ) { return; }

	$list = tcci_get_svg_list();
...
function tcci_get_svg_list() {
	...
	/**
	 * The tcci_svgs filter
	 */
	$list = apply_filters( 'tcci_svgs', $list );
 ...
 */
function tcci_get_thumbnail_url( $postID, $size = 'thumbnail' ) {
