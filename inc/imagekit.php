 ...
 */
function function_names_get_customizer_image_info( $name ) {
	...
	$id = function_names_get_image_id( $image_url );
...
} // function_names_get_customizer_image_info()
...
} // function_names_get_featured_images()
 ...
 */
function function_names_get_image_id( $image_url ) {
...
function function_names_get_svg( $svg ) {
	...
	$list = function_names_get_svg_list();
 ...
 */
function function_names_get_svg_list() {
