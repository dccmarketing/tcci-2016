...
class TCCi_Metaboxes {
	...
	public function add_metaboxes() {
		...
		add_meta_box(
			'metabox_name',
			apply_filters( $this->theme_name . '-metabox-name-title', esc_html__( 'Metabox Name', 'tcci' ) ),
			array( $this, 'metabox' ),
			'posttypename',
			'normal',
			'default',
	...
	public function change_featured_image_labels( $labels ) {
		...
		$labels->featured_image 		= esc_html__( 'Featured Image', 'tcci' );
		$labels->set_featured_image 	= esc_html__( 'Set featured image', 'tcci' );
		$labels->remove_featured_image 	= esc_html__( 'Remove featured image', 'tcci' );
		$labels->use_featured_image 	= esc_html__( 'Use as featured image', 'tcci' );
